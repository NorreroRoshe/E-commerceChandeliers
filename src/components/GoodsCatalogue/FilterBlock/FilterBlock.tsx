...
export const FilterBlock: React.FC<FilterProps> = React.memo(({ value, onChangeCategory }) => {                           //React.memo нужен, чтобы компонент больше не перерисовывался
  return (
        ...
        <div className={s.filter__fil}>
          <div className={s.filter__fil_price}>
            ...
            <div className={s.polsunok}>
              <App /> {/* как перекинуть сюда пропсы , в классовый космпанент */}
            </div>
          </div>
