    ...
    <footer className={styles.footer}>
      <div className={`${styles.footer__container} ${styles.container}`}>
        <div className={styles.footer_nav}>
          <h4 className={styles.footer_nav__title}>О магазине</h4>
          <ul className={styles.footer_nav__list}>
            <li className={styles.footer_nav__item}>
              <NavLink to="/" className={styles.nav_link}>
                О нас
              </NavLink>
              <NavLink to="/paypage" className={styles.nav_link}>
                Способ оплаты
              </NavLink>
              <NavLink to="/contacts" className={styles.nav_link}>
                Контакты
              </NavLink>
              <NavLink to="/delivery" className={styles.nav_link}>
                Доставка и возврат
              </NavLink>
              <NavLink to="/warranty" className={styles.nav_link}>
                Гарантия
              </NavLink>
            </li>
          </ul>
          <h5 className={styles.footer_nav__order_header}>
            Заказы через сайт принимаются c 8:00-23:00, без выходных
          </h5>
          <div className={styles.footer_nav__pay}>
            <img src={visaicon} alt="" className={styles.footer_nav__paym} />
            <img src={mastercard} alt="" className={styles.footer_nav__paym} />
            <img src={paypal} alt="" className={styles.footer_nav__paym} />
            <img src={visaelect} alt="" className={styles.footer_nav__paym} />
          </div>
        </div>
        <div className={styles.footer_nav}>
          <h4 className={styles.footer_nav__title}>Покупателю</h4>
          <ul className={styles.footer_nav__list}>
            <li className={styles.footer_nav__item}>
          ...
          <a href="" className={styles.footer_nav__linkapp}>
            <img src="" alt="" className={styles.footer_nav__linkapp_img} />
          </a>
        </div>
        <div className={styles.footer_nav}>
          <h4 className={styles.footer_nav__title}>Контакты</h4>
          <p className={styles.footer_nav_contadress}>Адрес Шоу-рума:</p>
          ...
          <div className={styles.footer_nav_nytime}>
            ...
            <p className={styles.nav_nytime_time}>Пн-Пт 9:00-21:00</p>
            <p className={styles.nav_nytime_time}>Сб-Вс 11:00-21:00</p>
          </div>
        ...
        <div className={styles.footer_nav_work}>
          <h4 className={styles.footer_nav_work_title}>Работа с нами</h4>
          <ul className={styles.nav_work_list}>
            <li className={styles.nav_work_item}>
              <NavLink to="/collaboration" className={styles.nav_work__link}>
                Сотрудничество
              </NavLink>
            </li>
            <li className={styles.nav_work_item}>
              <NavLink to="" className={styles.nav_work__link}>
                Вакансии
              </NavLink>
            </li>
          </ul>
      ...
      <p className={styles.footer_create}>© Galoyan design, 2022</p>
    </footer >
  )
}
